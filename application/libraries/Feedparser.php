	...
	private function characterData($parser, $data) 
	{
	   ...
	   if($this->inChannel())
	   {
			...
			if(in_array($this->getParentTag(), $this->hasSubTags))  
			{
				...
				$this->channels[$this->getParentTag()][$this->currentTag] .= ($data);
				return;
			}
			else
			{
				...
				{
					@$this->channels[$this->currentTag] .= ($data);
				}
			}
		   ...
		   if(in_array($this->getParentTag(), $this->hasSubTags))  
			{
				...
				$this->items[$this->itemIndex][$this->getParentTag()][$this->currentTag] .= ($data);
				return;
			}
			else
			{
				if(! in_array($this->currentTag, $this->hasSubTags))  
				{
					@$this->items[$this->itemIndex][$this->currentTag] .= ($data);
				}
			}
