            ...
            <div class="box-content">
                ...
                <form class="form-horizontal" action="<?php echo site_url('admin/system/savesitesettings/site_settings');?>" method="post">
                  ...
                  <div class="form-group">
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 col-lg-2 control-label"><?php echo lang_key('site_mode'); ?></label>
                        <div class="col-sm-9 col-md-4 controls">
                            <select name="site_mode" id="site_mode" class="form-control">
                                <?php $layouts = array('production'=>'Production','development'=>'Development','maintainance'=>'Maintainance')?>
                                <?php foreach($layouts as $key=>$row){?>
                                <?php $sel = ($key==$settings->site_mode)?'selected="selected"':'';?>
                                <option value="<?php echo $key;?>" <?php echo $sel;?>><?php echo $row;?></option>
                                <?php }?>
                            </select>
                            <span class="help-inline">&nbsp;</span>
                            <?php echo form_error('site_mode'); ?>
                        </div>
                    </div>
                    <!-- end -->

                    <div class="form-group">
                        <label class="col-sm-3 col-lg-2 control-label"><?php echo lang_key('facebook_page_name'); ?></label>

                        <div class="col-sm-9 col-lg-10 controls">
                            <input type="text" name="facebook_page_name" value="<?php echo(isset($settings->facebook_page_name))?$settings->facebook_page_name:'';?>" placeholder="<?php echo lang_key('type_something');?>" class="form-control" >
                            <span class="help-inline">&nbsp;</span>
                            <?php echo form_error('facebook_page_name'); ?>
                        </div>
                    </div>

                    <div class="form-group">
                        <label class="col-sm-3 col-lg-2 control-label"><?php echo lang_key('google_plus_name'); ?></label>

                        <div class="col-sm-9 col-lg-10 controls">
                            <input type="text" name="google_plus_name" value="<?php echo(isset($settings->google_plus_name))?$settings->google_plus_name:'';?>" placeholder="<?php echo lang_key('type_something');?>" class="form-control" >
                            <span class="help-inline">&nbsp;</span>
                            <?php echo form_error('google_plus_name'); ?>
                        </div>
                    </div>

                    <div class="form-group">
                        <label class="col-sm-3 col-lg-2 control-label"><?php echo lang_key('twitter_page_name'); ?></label>

                        <div class="col-sm-9 col-lg-10 controls">
                            <input type="text" name="twitter_page_name" value="<?php echo(isset($settings->twitter_page_name))?$settings->twitter_page_name:'';?>" placeholder="<?php echo lang_key('type_something');?>" class="form-control" >
                            <span class="help-inline">&nbsp;</span>
                            <?php echo form_error('twitter_page_name'); ?>
                        </div>
                    </div>
