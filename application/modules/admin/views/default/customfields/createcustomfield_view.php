...
<form action="<?php echo site_url('admin/customfields/save/');?>" method="post" id="save-option-form">
...
<div class="row">
	<div class="col-md-6">
			...
			<select class="form-control" name="category_id">
				...
				<?php 
				$v = (set_value('category_id')!='')?set_value('category_id'):'';
	...
	<div class="col-md-6">
			...
			<select class="form-control" name="fieldtype">
				...
				$v = (set_value('fieldtype')!='')?set_value('fieldtype'):'';
...
<div class="row">
	<div class="col-md-12">
			...
			<input class="form-control" type="text" name="fieldname" value="<?php echo(set_value('fieldname')!='')?set_value('fieldname'):'';?>">
...
<div class="row">	
	<div class="col-md-12">
		...
		<input class="form-control" type="text" name="options" value="<?php echo(set_value('options')!='')?set_value('options'):'';?>">
		<div style="font-style:italic">If using Checkbox, Radio or Select field types, you can specify the options available by adding a list of values separated by a comma. Example: Red,Blue,Yellow,Green.</div>
...
<div class="row">
	<div class="col-md-12">
		...
		<input class="form-control" type="text" name="help_text" value="<?php echo(set_value('help_text')!='')?set_value('help_text'):'';?>">
...
<div class="row">	
	<div class="col-md-4">
		<?php $chk = (set_value('is_required')!='')?'checked="checked"':'';?>
	...
	<div class="col-md-4">
		<?php $chk = (set_value('show_in_detail')!='')?'checked="checked"':'';?>
	...
	<!--div class="col-md-4">
		<?php $chk = (set_value('show_in_search')!='')?'checked="checked"':'';?>
