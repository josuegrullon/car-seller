    ...
    <div class="col-md-12">
        <div class="box">
            ...
            <form action="<?php echo site_url('admin/system/debugemail');?>" method="post">
                ...
                <input type="text" name="to_email" class="form-control" placeholder="youremail@example.com">
                <div class="clearfix" style="margin-top:10px;"></div>
                <input type="submit" value="<?php echo lang_key('send')?>" class="btn btn-primary">
            </form>
