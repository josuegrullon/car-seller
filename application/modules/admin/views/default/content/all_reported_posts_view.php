  ...
  <div class="col-md-12">
    ...
    <div class="box">
      ...
      <div class="box-title">
        ...
        <h3><i class="fa fa-bars"></i> <?php echo lang_key('all_reported_posts');?></h3>
      ...
      <div class="box-content">
        ...
        <div class="col-md-4 col-sm-4 col-xs-12 pull-right">
          ...
          <form action="<?php echo site_url('admin/content/allreported_posts_ajax/0');?>" method="post" id="table-search-from" class="form-inline pull-right">
            <div class="">
