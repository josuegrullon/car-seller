  ...
  <div class="col-md-12">
    ...
    <div class="box">
      ...
      <div class="box-content">
                  ...
                  <td data-title="<?php echo lang_key('actions');?>" class="numeric">
                    ...
                    <div class="btn-group">
                      ...
                      <ul class="dropdown-menu dropdown-info">
                          ...
                          <li><a class="detail" id="<?php echo $row->id;?>"><?php echo lang_key('detail'); ?></a></li>
                          <?php if(is_admin()){?>
                          <?php }?>
                      </ul>
        ...
        <a href="<?php echo site_url('admin/content/bulkemailform');?>" class="btn btn-success bulk-email"><?php echo lang_key('send_bulk_email');?></a>
        </div>
