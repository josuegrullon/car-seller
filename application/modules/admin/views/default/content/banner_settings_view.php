...
<div class="row">
  <div class="col-md-12">
    ...
    <form class="form-horizontal" id="addpackage" action="<?php echo site_url('admin/content/savebannersettings');?>" method="post">
    ...
    <div class="box">
      ...
      <div class="box-content">
          ...
          <div class="form-group">
            <label class="col-sm-3 col-lg-2 control-label">Show banner:</label>
            <div class="col-sm-4 col-lg-5 controls">
                <?php $v = (set_value('show_banner')!='')?set_value('show_banner'):get_settings('banner_settings','show_banner', 8);?>
                <select id="show_banner" name="show_banner" class="form-control input-sm">
                    <?php 
...
<!--                    <input class="form-control" type="text" name="map_zoom" id="map_zoom" value="--><?php //echo $v;?><!--">-->
    ...
    <div class="box">
      ...
      <div class="box-content">
          ...
          <!-- added on version 1.6 -->
          <div class="form-group">
            <label class="col-sm-3 col-lg-2 control-label"><?php echo lang_key('show_search_panel');?>:</label>
            <div class="col-sm-4 col-lg-5 controls">
                <?php $v = (set_value('show_search_panel')!='')?set_value('show_search_panel'):get_settings('banner_settings','show_search_panel', 8);?>
                <select id="show_search_panel" name="show_search_panel" class="form-control input-sm">
                    <?php 
                    $options = array('Yes','No');
                    foreach($options as $val){
                        $sel = ($val==$v)?'selected="selected"':''; ?>
         ...
         <!-- end -->
            ...
            <!-- added on vewrsion 1.5 -->
            <div class="form-group">
              <label class="col-sm-3 col-lg-2 control-label"><?php echo lang_key('search_panel_filter_type');?>:</label>
              <div class="col-sm-4 col-lg-5 controls">
                  <?php $v = (set_value('search_panel_filter_type')!='')?set_value('search_panel_filter_type'):get_settings('banner_settings','search_panel_filter_type', 'basic_options');?>
                  <select id="search_panel_filter_type" name="search_panel_filter_type" class="form-control input-sm">
                      <?php 
                      $options = array('basic_options','advanced_options_with_country_state');// updated on version 1.8
          ...
          <div class="form-group bg-img">
            ...
            <div class="form-group bg-img">
                ...
                <div class="col-sm-4 col-lg-5 controls">                    
                    ...
                    <iframe src="<?php echo site_url('admin/content/searchbguploader');?>" style="border:0;margin:0;padding:0;height:130px;"></iframe>
                    <span class="help-inline">&nbsp;</span>
                </div>          
            </div>
            <div class="clearfix"></div>
