                  ...
                  <td data-title="<?php echo lang_key('actions');?>" class="numeric">
                    ...
                    <div class="btn-group">
                      ...
                      <ul class="dropdown-menu dropdown-info">
                          ...
                          <li><a href="<?php echo post_detail_url($row);?>" target="_blank"><i class="fa fa-laptop" aria-hidden="true"></i> <?php echo lang_key('view_on_front');?></a></li>
                          <li><a href="<?php echo site_url('edit-car/'.$curr_page.'/'.$row->id);?>"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> <?php echo lang_key('edit');?></a></li>
                          <li><a href="<?php echo site_url('admin/content/deletepost/'.$curr_page.'/'.$row->id);?>"><i class="fa fa-trash" aria-hidden="true"></i> <?php echo lang_key('delete');?></a></li>
                          <li><a href="<?php echo site_url('admin/content/view_all_reviews/'.$curr_page.'/'.$row->id);?>">
                          <i class="fa fa-star-half-o" aria-hidden="true"></i> <?php echo lang_key('view_all_reviews');?></a></li>
                          <?php if(is_admin()){?>
                            <?php if($row->status==2){?>
                            <li><a href="<?php echo site_url('admin/content/approvepost/'.$curr_page.'/'.$row->id);?>">
                            <i class="fa fa-check-square-o" aria-hidden="true"></i> <?php echo lang_key('approve');?></a></li>
                            <?php }?>
                            <?php if($row->featured==0 && $row->status==1){?>
                            <li><a class="make-featured" data-postid="<?php echo $row->id;?>" href="javascript:void(0)">
                              <i class="fa fa-bookmark-o" aria-hidden="true"></i> <?php echo lang_key('make_featured');?></a></li>
                            <?php }if($row->featured==1 && $row->status==1){?>
                            <li><a href="<?php echo site_url('admin/content/removefeaturepost/'.$curr_page.'/'.$row->id);?>">
                            <i class="fa fa-bookmark-o" aria-hidden="true"></i> <?php echo lang_key('remove_featured');?></a></li>
                            <li><a class = "renew-featured" data-postid="<?php echo $row->id;?>" href="javascript:void(0)">
                            <i class="fa fa-bookmark-o" aria-hidden="true"></i> <?php echo lang_key('renew_featured');?></a></li>
                            <?php }?>
                          <?php }else{?>
                            <?php if(get_settings('package_settings','enable_featured_pricing','No')=='Yes' && $row->featured==0 && $row->status==1){?>
                            <li><a href="<?php echo site_url('admin/content/choosefeaturepackage/'.$row->id);?>"><i class="fa fa-bookmark-o" aria-hidden="true"></i> <?php echo lang_key('make_featured');?></a></li>
                            <?php }else if(get_settings('package_settings','enable_featured_pricing','No')=='Yes' && $row->featured==1 && $row->status==1){?>
                            <li><a href="<?php echo site_url('admin/content/choosefeaturepackagerenew/'.$row->id);?>"><i class="fa fa-bookmark-o" aria-hidden="true"></i> <?php echo lang_key('renew_featured');?></a></li>
                            <?php }?>
                          <?php }?>
                          <?php if($row->status==4){ // if post is expired give an option to renew?>
                              <li><a href="<?php echo site_url('user/payment/chooserenewpackage/'.$row->id);?>"><i class="fa fa-paypal" aria-hidden="true"></i> <?php echo lang_key('renew_package');?></a></li>
                          <?php }?> 
