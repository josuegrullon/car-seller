        ...
        <table id="all-posts" class="table table-hover table-advance">
           ...
           <thead>
               ...
               <tr>
                  ...
                  <th class="numeric serial" style="width:50px;">#</th>
                  ...
                  <td data-title="<?php echo lang_key('actions');?>" class="numeric">
                    ...
                    <div class="btn-group">
                      ...
                      <ul class="dropdown-menu dropdown-info">
                          ...
                          <li><a href="<?php echo site_url('admin/content/view_all_reviews/'.$curr_page.'/'.$row->id);?>"><?php echo lang_key('view_all_reviews');?></a></li>
                          <?php if(is_admin()){?>
                            <?php if($row->status==2){?>
                            <li><a href="<?php echo site_url('admin/content/approvepost/'.$curr_page.'/'.$row->id);?>"><?php echo lang_key('approve');?></a></li>
                            <?php }?>
                            ...
                            <?php }else{?>
                            <li><a href="<?php echo site_url('admin/content/removefeaturepost/'.$curr_page.'/'.$row->id);?>"><?php echo lang_key('remove_featured');?></a></li>
                          ...
                          <?php }else{?>
                            ...
                            <li><a href="<?php echo site_url('admin/content/choosefeaturepackage/'.$row->id);?>"><?php echo lang_key('make_featured');?></a></li>
                            <?php }else{?>
                            <li><a href="<?php echo site_url('admin/content/choosefeaturepackagerenew/'.$row->id);?>"><?php echo lang_key('renew_featured');?></a></li>
                            <?php }?>
                          <?php }?>
                      </ul>
