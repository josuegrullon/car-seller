	...
	<div class="col-md-12">
		...
		<div class="box">
			...
			<div class="box-content">
				...
				<a id="sel_lang_form" href="<?php echo site_url('admin/system/editlang/'.$row->id);?>" class="btn btn-primary"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> <?php echo lang_key('edit');?></a>

				<!--a id="edit_as_new_lang" href="<?php echo site_url('admin/system/editasnewlang/'.$row->id);?>" class="btn btn-info">Edit As New</a-->

				<a id="delete_lang" href="<?php echo site_url('admin/system/deletelang/'.$row->id);?>" class="btn btn-danger"><i class="fa fa-trash" aria-hidden="true"></i> <?php echo lang_key('delete');?></a>
