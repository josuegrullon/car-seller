        ...
        <div class="box">
            ...
            <div class="box-content">
                ...
                <?php } else { ?>
                    ...
                    <a href="<?php echo site_url('admin/users/exportphones');?>" class="btn btn-primary"><?php echo lang_key('export_user_phone'); ?></a>
                    <!-- added on version 1.5 -->
                    <a href="<?php echo site_url('admin/users/sendemail'); ?>" class="btn btn-warning"><?php echo lang_key('send_email_to_users');?></a>
                    <!-- end -->
                                ...
                                <tr>
                                    ...
                                    <td data-title="<?php echo lang_key('status');?>" class="numeric">
                                        ...
                                        if ($row->confirmed != 1)
                                             ...
                                             echo '<div class="label label-info">'.lang_key('USER_PENDING').'</div>';

                                        else if ($row->banned == 1)

                                            echo '<div class="label label-danger">'.lang_key('USER_BANNED').'</div>';

                                        else {

                                            echo '<div class="label label-success">'.lang_key('USER_ACTIVE').'</div>';
                                    ...
                                    <td data-title="<?php echo lang_key('options');?>" class="numeric">
                                        ...
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu dropdown-info">
                                                ...
                                                <li><a href="<?php echo site_url('admin/edituser/' . $row->id); ?>"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> <?php echo lang_key('edit');?></a>

                                                </li>

                                                <li><a href="<?php echo site_url('admin/userdetail/' . $row->id); ?>"><i class="fa fa-user" aria-hidden="true"></i> Detail</a>

                                                </li>

                                                <?php if($row->confirmation_key!=''){?>

                                                <li><a href="<?php echo site_url('admin/confirmuser/'.$page.'/'. $row->id); ?>"><i class="fa fa-check" aria-hidden="true"></i> Confirm</a>
                                                ...
                                                <?php if($row->user_type!=1){?>
                                                    ...
                                                    <li><a href="<?php echo site_url('admin/deleteuser/'.$page.'/'. $row->id); ?>"><i class="fa fa-trash" aria-hidden="true"></i> <?php echo lang_key('delete');?></a>
                                                    ...
                                                    if ($row->banned == 1) {
                                                        ...
                                                        <li>
                                                            ...
                                                            <a href="<?php echo site_url('admin/users/unban_user/' . $row->id . '/' . $this->uri->segment(5)); ?>"><i class="fa fa-check" aria-hidden="true"></i> Un-Ban</a>
