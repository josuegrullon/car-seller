            ...
            <div class="box-content">
                <div class="row">
                    ...
                    <div class="col-md-9 user-profile-info">
                        ...
                        <p>
                            <span><?php echo lang_key('email'); ?>:</span>
                                <?php if($this->session->userdata('user_email')!=$profile->user_email){?>
                                <a href="<?php echo site_url('admin/users/sendemail/'.$profile->id);?>">
                        ...
                        <p>
                            ...
                            <a href="<?php echo site_url('admin/deleteuser/' . $profile->id); ?>" class="btn btn-danger"><i class="fa fa-trash" aria-hidden="true"></i> <?php echo lang_key('delete');?></a>
                        </p>
                        <?php }?>
                    </div>
                </div>
