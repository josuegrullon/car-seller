                    ...
                    <?php foreach($widgets->result() as $row){?>
                        <?php if(isset($active_widgets_array[$row->alias])==FALSE){?>
                            <li class="thumbnail" style="margin-bottom:10px;cursor: move;height:41px;">
                                ...
                                <a href="<?php echo site_url('admin/widgets/edit/'.$row->alias);?>" style="float:right;" class="edit-widget btn btn-info"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> <?php echo lang_key('edit');?></a>
                            </li>
                        <?php }?>
                    <?php }?>
                </ol>
                            ...
                            foreach ($active_widgets as $widget) 
                            {
                                ...
                                else
                                {
                                    ...
                                    <li class="thumbnail" style="margin-bottom:10px;cursor: move;height:41px;">
                                        ...
                                        <div style="float:left;padding:5px;"><?php echo $row->name;?></div>
                                        <a href="<?php echo site_url('admin/widgets/edit/'.$widget);?>" style="float:right;" class="edit-widget btn btn-info"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> <?php echo lang_key('edit');?></a>
                                    </li>
                                <?php
                                }
                            }
