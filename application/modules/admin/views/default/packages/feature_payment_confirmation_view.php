    ...
    <div class="contact-us-three">
        ...
        <div class="row">
            ...
            <div class="col-md-12 col-sm-12">
                ...
                <div class="label label-success"><?php echo lang_key('expiration_time');?> : <?php echo $package->expiration_time;?> <?php echo lang_key('days'); ?> </div><div class="clearfix" style="margin-top:5px;"></div>
                ...
                <?php if(get_settings('package_settings','enable_featured_paypal_transfer','Yes')=='Yes'){?>
                ...
                <?php echo get_settings('package_settings','bank_transfer_instruction_for_featured_posts','');?>                
