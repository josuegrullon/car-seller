                    ...
                    <div id="no-more-tables">
                        ...
                        <table id="all-posts" class="table table-hover">
                            ...
                            <tr>
                                ...
                                <th class="numeric"><?php echo lang_key('expiration_time');?></th>
                                <th class="numeric"><?php echo lang_key('featured_expiration_time');?></th>
                                <th class="numeric"><?php echo lang_key('max_gallery_photos');?></th>
                            ...
                            foreach ($packages->result() as $row): 
                                ...
                                <tr>
                                    ...
                                    <td data-title="<?php echo lang_key('expiration_time');?>" class="numeric"><?php echo $row->expiration_time.' '.lang_key('days');?></td>
                                    <td data-title="<?php echo lang_key('featured_expiration_time');?>" class="numeric"><?php echo $row->featured_expiration_time.' '.lang_key('days');?></td>
                                    <td data-title="<?php echo lang_key('max_gallery_photos');?>" class="numeric"><?php echo $row->max_gallery_photos.' '.lang_key('photos');?></td>
                                    ...
                                    <td data-title="<?php echo lang_key('options');?>" class="numeric">
                                        ...
                                        <div class="btn-group">
                                          ...
                                          <ul class="dropdown-menu dropdown-info">
                                              ...
                                              <li><a href="<?php echo site_url('admin/package/edit_package/'.$row->id);?>" class="edit-location"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> <?php echo lang_key('edit');?></a></li>
                                              <li><a href="<?php echo site_url('admin/package/remove_package/'.$row->id); ?>"><i class="fa fa-trash" aria-hidden="true"></i> <?php echo lang_key('delete');?></a></li>
