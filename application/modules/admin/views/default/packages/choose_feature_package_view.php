                ...
                <div class="box-content">
                    ...
                    ?>
                        ...
                        <?php foreach($packages->result() as $package):?>
                            <?php $action = (isset($alias) && $alias=='renew')?site_url('admin/content/renewfeaturepayment'):site_url('admin/content/featurepayment');?>
                                ...
                                <div class="col-md-4 col-sm-4">
                                    <div class="thumbnail thumb-shadow">
                                        ...
                                        <div class="caption">
                                           ...
                                           <div style="clear:both; border-bottom:1px solid #ccc; margin:10px 0px;"></div>
                                            <div style="clear:both;">
                                                <span class="rtl-right" style="float:left; font-weight:bold;"><?php echo lang_key('featured'); ?>:</span>
                                                <span class="rtl-left" style="float:right; "><?php echo $package->featured_expiration_time;?> <?php echo lang_key('days'); ?></span>
                                            </div>
                                           <?php if($package->type=='post_package'){?> 
                                           <div style="clear:both; border-bottom:1px solid #ccc; margin:10px 0px;"></div>
                                            <div style="clear:both;">
                                                <span class="rtl-right" style="float:left; font-weight:bold;"><?php echo lang_key('gallery_limit'); ?>:</span>
                                                <span class="rtl-left" style="float:right; "><?php echo $package->max_gallery_photos;?> <?php echo lang_key('photos'); ?></span>
                                            </div>
                                            <?php }?>
                                            <div style="clear:both; border-bottom:1px solid #ccc; margin:10px 0px;"></div>                            
                                            <p>
