...
class System_model_core extends CI_Model 
{
	...
	function get_language_data($file_name)
	{
		...
		$lang =  $this->yaml->parse_file('./web_config/locals/'.$file_name);
		return $lang;
	}
	...
	function get_email_tmpl_by_email_name($name)
	{
		...
		$file 		= './web_config/locals-email/'.$lang.'_'.$name.'.xml';
	...
	function get_unused_images($action='get')
	{
		...
		$filter = array('index.html','thumb','nophoto-.jpg','nophoto-male.jpg','nophoto-female.jpg','thumb\\');
		foreach ($images as $img) {
