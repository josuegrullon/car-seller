...
<fieldset>
	...
	<label>DB Name :</label> 
	<input type="text" name="db_name" value="<?php if(set_value('db_name')!='')echo set_value('db_name');else echo 'carbiz';?>" placeholder="Db name" class="input-xxlarge" >
	<?php echo form_error('db_name'); ?>
	<label>DB Table Prefix :</label> 
	<input type="text" name="db_prefix" value="<?php if(set_value('db_prefix')!='')echo set_value('db_prefix');else echo 'web_';?>" placeholder="Db tableprefix" class="input-xxlarge" >
