<div class="page-heading-two">
    <div class="container">
        <div class="col-md-7">
            <h5 class="car-title-detail"><?php echo lang_key('all_users');?></h5>
        </div>
        <div class="col-md-5">
        <div class="breads">
                        ...
                        <form method="post" action="">
                            <div class="input-group">
                                ...
                                <span class="input-group-btn">
                                    <button class="btn btn-primary" type="submit"><?php echo lang_key('search'); ?></button>
                                </span>
                            </div>
                        </form>
                    </div>
                    ...
                    ?>
                        <div class="row">
                                    ...
                                    <a href="<?php echo site_url('profile/'.$user->id.'/'.get_user_fullname_by_id($user->id));?>">
                                        <img class="img-responsive user-photo-list" src="<?php echo get_profile_photo_by_id($user->id,'thumb');?>" alt="user-photo" />

                                    </a>
                                        <a href="<?php echo site_url('profile/'.$user->id.'/'.get_user_fullname_by_id($user->id));?>" class="member-post-count"><span class="label label-red"><?php echo get_user_properties_count($user->id);?> <?php echo lang_key('posts');?></span></a>
