<div class="page-heading-two">
    <div class="container">
        <div class="col-md-7">
            <h5 class="car-title-detail"><?php echo lang_key('signup');?></h5>
        </div>
        <div class="col-md-5">
        <div class="breads">
            <a href="<?php echo site_url(); ?>"><?php echo lang_key('home'); ?></a> / <?php echo lang_key('signup'); ?>
        </div>
        </div>
    ...
    <div class="row">
        ...
        <div class="col-md-7">
            ...
            <div class="well login-reg-form" >
                ...
                <?php echo $this->session->flashdata('msg');?> <!-- added on version 1.9 -->
                <hr />
                <!-- Form -->
                <!-- Form Horizontal -->
                <form style="max-width: 615px" class="form-horizontal" role="form" action="<?php echo site_url('account/register/');?>" method="post">
                        ...
                        <div class="col-sm-offset-3 col-sm-9">
                            ...
                            <div class="checkbox">
                                <label>
                                    ...
                                    <?php echo lang_key('ive_read_the'); ?> <a target="_blank" href="<?php echo site_url('page/terms_and_conditions');?>"><?php echo lang_key('terms_and_conditions'); ?></a>
                                </label>
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-3 col-sm-9">
                            <!-- Buton -->
                            <button type="submit" class="btn btn-success"><?php echo lang_key('register'); ?></button>&nbsp;
