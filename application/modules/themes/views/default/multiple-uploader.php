...
<form id="logo-uploader-form" action="<?php echo site_url('user/upload_brochurefile');?>" method="post" enctype="multipart/form-data" style="display:none">
...
jQuery(document).ready(function(){
    ...
    jQuery('#photoimg_logo').change(function(){
            ...
            var uploadURL = '<?php echo site_url("user/upload_brochurefile");?>'; //Upload URL
            var extraData ={}; //Extra Data.
            var jqXHR=$.ajax({
                    xhr: function() {
                    var xhrobj = $.ajaxSettings.xhr();
