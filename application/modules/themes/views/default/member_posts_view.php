...
<div class="page-heading-two">
    <div class="container">
        <div class="col-md-7">
            <h5 class="car-title-detail"><?php echo get_user_fullname_by_id($user->id); ?></h5>
        </div>
        <div class="col-md-5">
        <div class="breads">
                ...
                <div class="team-two">
                    <div class="row">
                           ...
                           <div class="col-md-2 col-sm-2 col-xs-12">
                                ...
                                <img class="img-responsive user-photo-list" src="<?php echo get_profile_photo_by_id($user->id,'thumb');?>" alt="" />
