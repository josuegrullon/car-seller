<div class="page-heading-two">
    <div class="container">
        <div class="col-md-7">
            <h5 class="car-title-detail"><?php echo lang_key('contact_us');?></h5>
        </div>
        <div class="col-md-5">
        <div class="breads">
            ...
            <div class="col-md-9 col-sm-12 col-xs-12">
                ...
                <div class="contact-form">
                    ...
                    <form action="<?php echo site_url('sendcontactemail');?>" method="post">
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-md-4 contact-captcha">
                        ...
                        <!-- Button -->
                        <input class="btn btn-primary" type="submit" value="<?php echo lang_key('send') ?>">

                        <button type="reset" class="btn btn-default"><?php echo lang_key('reset') ?></button>
                    </form>
                </div>
