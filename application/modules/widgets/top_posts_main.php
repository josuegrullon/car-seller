...
<div class="block-heading-two">
    <h3><span><i class="fa fa-clock-o"></i> <?php echo lang_key('top_posts'); ?></span>
        <div class="pull-right list-switcher">
            <a target="recent-posts" href="<?php echo site_url('show/topposts_ajax/'.$per_page.'/grid');?>"><i class="fa fa-th "></i></a>
        	<a target="recent-posts" href="<?php echo site_url('show/topposts_ajax/'.$per_page.'/list');?>"><i class="fa fa-th-list "></i></a>
        </div>
    </h3>
</div>
...
<a href="" class="load-more-recent btn btn-primary" style="width:100%"><?php echo lang_key('load_more_recent_posts');?></a>
