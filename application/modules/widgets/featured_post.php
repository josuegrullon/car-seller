...
<div class="s-widget">
    <!-- Heading -->
    <h5><i class="fa fa-bookmark color"></i>&nbsp; <?php echo lang_key('featured_cars');?></h5>
    <!-- Widgets Content -->
            ...
            <ul class="list-unstyled">
                ...
                foreach ($query->result() as $post) {
                    ...
                    <li class="col-xs-12 col-sm-6 col-md-12 col-lg-12">
                        ...
                        <!-- Price -->
                        <div class="price"><strong><?php echo lang_key('city');?></strong>: <?php echo get_location_name_by_id($post->city);?><br/>
